...
const cpuObj = {
    init(content) {
        try {
            ...
            this.cpuNi =  (parseInt(parseCpu[1]) - this.beforeCpuNi)*100.0/diffTotal;
            this.cpuSy =  (parseInt(parseCpu[2]) - this.beforeCpuSy)*100.0/diffTotal;
            ...
            this.cpu0ni = (parseInt(parseCpu0[1]) - this.beforeCpu0ni)*100.0/diffTotal0;
            this.cpu0sy = (parseInt(parseCpu0[2]) - this.beforeCpu0sy)*100.0/diffTotal0;
            ...
            this.cpu1ni = (parseInt(parseCpu1[1]) - this.beforeCpu0ni)*100.0/diffTotal1;
            this.cpu1sy = (parseInt(parseCpu1[2]) - this.beforeCpu1sy)*100.0/diffTotal1;
            ...
            this.cpu2ni = (parseInt(parseCpu2[1]) - this.beforeCpu2ni)*100.0/diffTotal2;
            this.cpu2sy = (parseInt(parseCpu2[2]) - this.beforeCpu2sy)*100.0/diffTotal2;
            ...
            this.cpu3ni = (parseInt(parseCpu3[1]) - this.beforeCpu3ni)*100.0/diffTotal3;
            this.cpu3sy = (parseInt(parseCpu3[2]) - this.beforeCpu3sy)*100.0/diffTotal3;
